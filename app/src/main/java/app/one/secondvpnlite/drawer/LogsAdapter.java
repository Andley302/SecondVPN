...
import app.one.secondvpnlite.logs.LogItem;
import app.one.secondvpnlite.logs.AppLogManager;

import app.one.secondvpnlite.*;

public class LogsAdapter extends RecyclerView.Adapter<LogsAdapter.logViewHolder>
	implements AppLogManager.LogListener, Handler.Callback,
		View.OnTouchListener
{
	...
	private final Vector<LogItem> currentLevelEntries = new Vector<LogItem>();
	...
	{ 
		...
		/*if (new Settings(mContext).getModoDebug()) {
			setLogLevel(AppLogManager.LogLevel.DEBUG.getInt());
		}*/
		...
		AppLogManager.addLogListener(this);
	} 
	...
	{
		allEntries.clear();
		Collections.addAll(allEntries, AppLogManager.getlogbuffer());
		initCurrentMessages();
	}
