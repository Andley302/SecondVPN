...
public class LogItem implements Parcelable {
    ...
    AppLogManager.LogLevel mLevel = AppLogManager.LogLevel.INFO;
	...
	public LogItem(AppLogManager.LogLevel loglevel, int verblevel, String msg) {
        mLevel = loglevel;
        mMessage = msg;
		mVerbosityLevel = verblevel;
    }

    public LogItem(AppLogManager.LogLevel level, int resId, Object... args) {
        mLevel = level;
		mResourceId = resId;
		mArgs = args;
    }
	
	public LogItem(AppLogManager.LogLevel loglevel, String msg) {
        mLevel = loglevel;
        mMessage = msg;
    }


    public LogItem(AppLogManager.LogLevel loglevel, int ressourceId) {
    ...
    public LogItem(Parcel in) {
        ...
        mLevel = AppLogManager.LogLevel.getEnumByValue(in.readInt());
        logtime = in.readLong();
    }
    ...
    public AppLogManager.LogLevel getLogLevel() {
        return mLevel;
    }
    ...
    private String getAppInfoString(Context c) {
        ...
        String version = "Erro ao obter versão";
        try {
