...
import app.one.secondvpnlite.tunnel.CustomNativeLoader;
import app.one.secondvpnlite.tunnel.StreamGobbler;
...
public class Tun2Socks extends Thread implements StreamGobbler.OnLineListener {
	...
	public void run() {
		...
		try {
			...
			////AppLogManager.logException("Tun2Socks Error", e);
		} catch (Exception e) {
			////AppLogManager.logDebug("Tun2Socks Error: " + e.getMessage());
		}
	...
	public void onLine(String log){
		////AppLogManager.logDebug("Tun2Socks: " + log);
	}
	...
	private boolean sendFd(ParcelFileDescriptor fileDescriptor, File toFile) throws InterruptedException {
		...
		////AppLogManager.logDebug("Enviando Fd para sock");
